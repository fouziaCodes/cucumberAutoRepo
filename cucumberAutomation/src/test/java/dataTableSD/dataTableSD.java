...
public void user_enters_following_data(DataTable table) {
	...
	String header1 = cells.get(0).get(0);
	String header2 = cells.get(0).get(1);
	String header3 = cells.get(0).get(2);
	
	String userFirstName1 = cells.get(1).get(0);
	String userLastName1 = cells.get(1).get(1);
	String mobNum1 = cells.get(1).get(2);
	
	String userFirstName2 = cells.get(2).get(0);
	String userLastName2 = cells.get(2).get(1);
	String mobNum2 = cells.get(2).get(2);
	
	driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys(cells.get(0).get(0));
	driver.findElement(By.name("lastname")).sendKeys();
	driver.findElement(By.xpath("//input[@name='reg_email__']")).sendKeys(mobNum2);
...
//}
//
//@And("user enters {string} mobile number")
//public void user_enters__mobile_number(String mobNum) {
//	driver.findElement(By.id("u_2_g_+k")).sendKeys(mobNum);
//}
//
@Then("close browser")
