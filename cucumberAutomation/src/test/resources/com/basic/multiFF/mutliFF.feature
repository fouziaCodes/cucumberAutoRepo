Feature: 8 Create Account in Facebook
As a user I want to open facebook home page and create an account


Scenario: Validate First Name field 8-1
...
Scenario: Validate create user multiple fields and password field is empty 8-2
Given user is on facebook home page and clicks on Create Account
